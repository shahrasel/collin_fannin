...
class grace_church_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => esc_html__('The recent blog posts (extended)', 'grace-church'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'grace_church_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'grace_church_widget_recent_posts', esc_html__('Grace-Church - Recent Posts', 'grace-church'), $widget_ops, $control_ops );
