...
/**
 * Template Name: Co-Working 2 Template
...
<div class="container">
<h1 style="color: rgb(255, 255, 255);background-color: rgb(131, 132, 142); text-align: center;padding:15px;margin-top:0px;">Co-Working 2</h1>
...
<div class="content" id="form-content-area" style="background-color:#FFF">
  ...
  <div class="double_col firstblock_full">
    <h2>WHY USE A CO-WORKING SPACE FROM WORK PLACE CENTERS?</h2>
    <ul style="margin-bottom: 20px;">
      <li>Get a <strong>dedicated local telephone number</strong> – Our professional team will handle your calls.</li>
      <li>Get a <strong>mailing address</strong> – We will receive and sign for mail and packages.</li>
    ...
    <a style="margin-top: 2.667rem;cursor:pointer" class="sc_button sc_button_square sc_button_style_filled sc_button_size_medium" onclick="scrolltochart()">COMPARE CO-WORKING BUNDLES</a>
    </div>
  <div class="double_col firstblock_full">
    <div id="form1">
  ...
  <div class="content" style="padding-top: 35px;background-color:#FFF">
    ...
    <div class="three_col" style="background-color:#FFF">
      <table width="100%" class="vo_table">
        <tr>
          <td width="36%" align="left" valign="bottom" bgcolor="#FFFFFF"><h2>Co-Working product benefits</h2></td>
          <td width="16%" bgcolor="#FFFFFF" align="center"><h2>$129</h2></td>
          <td width="16%" bgcolor="#FFFFFF" align="center"><h2>$179</h2></td>
          <td width="16%" bgcolor="#FFFFFF" align="center"><h2>$279</h2></td>
          <td width="16%" bgcolor="#FFFFFF" align="center"><h2>$379</h2></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="center" valign="middle" bgcolor="#F2F2F2">1 Day</td>
          <td align="center" valign="middle" bgcolor="#F2F2F2">2 Days</td>
          <td align="center" valign="middle" bgcolor="#F2F2F2">5 Days</td>
          <td align="center" valign="middle" bgcolor="#F2F2F2">5 Days</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="center" valign="middle" bgcolor="#FFFFFF">Unlimited</td>
          <td align="center" valign="middle" bgcolor="#FFFFFF">Unlimited</td>
          <td align="center" valign="middle" bgcolor="#FFFFFF">Unlimited</td>
          <td align="center" valign="middle" bgcolor="#FFFFFF">Unlimited</td>
        </tr>
