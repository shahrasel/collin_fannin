...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<dl>
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<dd>
				<abbr class="tribe-events-abbr updated published dtstart" title="<?php ( $start_ts ) ?>"> <?php echo( $start_date ) ?> </abbr>
			</dd>

			<dt> <?php esc_html_e( 'End:', 'tribe-events-calendar' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr dtend" title="<?php ( $end_ts ) ?>"> <?php echo( $end_date ) ?> </abbr>
			</dd>
		...
		elseif ( tribe_event_is_multiday() ) :
			...
			<dt> <?php esc_html_e( 'Start:', 'tribe-events-calendar' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr updated published dtstart" title="<?php ( $start_ts ) ?>"> <?php echo( $start_datetime ) ?> </abbr>
			</dd>

			<dt> <?php esc_html_e( 'End:', 'tribe-events-calendar' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr dtend" title="<?php ( $end_ts ) ?>"> <?php echo( $end_datetime ) ?> </abbr>
			</dd>
