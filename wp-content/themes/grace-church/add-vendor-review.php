...
/**
 * Template Name: ADD Vendor Review Template
...
$cat_lists = $wpdb->get_results("select id,email, fname, lname from bestof_users order by fname asc",'ARRAY_A');
...
if(!empty($_SESSION['ses_user'])):
	...
	<div class="sc_contact_form_wrap" style="margin-bottom:40px">
        ...
        <a style="color:#fff;margin: 10px 0px;display: inline-block" href="<?php echo site_url() ?>/add-vendor-review"><button style="background-color: #ff9279">Add Vendor Review</button></a>
  ...
  box-shadow: 5px 10px 8px #888888;margin-bottom:30px;" id="error_message">
            ...
            <div class="sc_contact_form_info">
                <div class="sc_contact_form_item sc_contact_form_field label_over">
                    <label for="name">Vendor <span style="color: #ff0000">*</span></label>
                    <select name="vendor" id="vendor" style="border:2px solid #F4F4F4 !important;width: 100%;height: 46px;">
                        <option value="">-- Select Vendor --</option>
                        <?php foreach ($cat_lists as $cat_list): ?>
                            <option value="<?php echo $cat_list['id'] ?>"><?php echo $cat_list['fname'].' '.$cat_list['lname'].' ('.$cat_list['email'].')' ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="sc_contact_form_item sc_contact_form_field label_over">
                    <label for="username">Rating <span style="color: #ff0000">*</span></label>
                    <select name="rating" id="rating" style="border:2px solid #F4F4F4 !important;width: 100%;height: 46px;">
                ...
                <div class="clearfix"></div>
                <div class="sc_contact_form_item sc_contact_form_field label_over">
                    <label for="username">Write Review </label>
                    <textarea name="rating_desc" style="border:2px solid #F4F4F4 !important;width: 100%;height: 146px;"></textarea>
                </div>
              ...
              <input type="submit" class="scheme_original" value="ADD REVIEW"  onclick="return formvalidation()">
          </div>
