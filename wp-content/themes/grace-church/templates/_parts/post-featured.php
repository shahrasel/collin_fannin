<?php
					if ($post_data['post_video']) {
						echo trim(grace_church_get_video_frame($post_data['post_video'], $post_data['post_video_image'] ? $post_data['post_video_image'] : $post_data['post_thumb']));
					} else if ($post_data['post_audio']) {
						if (grace_church_get_custom_option('substitute_audio')=='no' || !grace_church_in_shortcode_blogger(true))
							echo trim(grace_church_get_audio_frame($post_data['post_audio'], $post_data['post_audio_image'] ? $post_data['post_audio_image'] : $post_data['post_thumb_url']));
						else
